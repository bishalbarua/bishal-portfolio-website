...
```bash
git remote add encore encore://bishal-portfolio-website-ghri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/bishal-portfolio-website-ghri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/bishal-portfolio-website-ghri/settings/integrations/github)
