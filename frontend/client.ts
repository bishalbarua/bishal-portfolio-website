 ...
 */
export class Client {
    public readonly portfolio: portfolio.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.portfolio = new portfolio.ServiceClient(base)
    }
 ...
 */
import { submitContactForm as api_portfolio_contact_submitContactForm } from "~backend/portfolio/contact";
...
export namespace portfolio {
    ...
    export class ServiceClient {
         ...
         */
        public async submitContactForm(params: RequestType<typeof api_portfolio_contact_submitContactForm>): Promise<ResponseType<typeof api_portfolio_contact_submitContactForm>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/contact`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_portfolio_contact_submitContactForm>
        }
    }
}
